...
The web of trust approach requires infinite trust transitivity in that
for one node to trust another,
at least one path of direct trusted edges must exist between them.
