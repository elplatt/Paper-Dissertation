...
Existing network trust models, such as web of trust, fail to adequately address
...
web of trust. We show that the partial trust model, when combined with
...
algorithm for implementing this scheme on the butterfly network topology.
