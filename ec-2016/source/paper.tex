...
but one having the bitstring equal to $z$ with the $l$th bit inverted.

The wrap-around butterfly network has a number of properties desired for
a scalable, decentralized communication network.
\begin{description}
\item[Vertex-transitive.]
Vertex transitivity means that the network is maximally decentralized.
