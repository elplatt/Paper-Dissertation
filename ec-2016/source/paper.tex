...
TODO: Fix bibtex encoding. dfsdfsdfsd
...
In this paper, we formally evaluate the effects of network structure on
attack-resistance. We also propose an efficient, fault-tolerant network architecture.
Our analysis focuses on {\em structured networks},
in which links between nodes are constrained to a particular architecture.
The proposed fault-tolerant architecture utilizes {\em multipath routing},
in which many possible paths exist betweeen two nodes on a communication network.
In our case, multiple paths allow multiple copies of a message to be sent,
