...
\epigraph{The Net interprets censorship as damage and routes around it.}{\textit{--John Gilmore}\cite{first_elmer-dewitt_1993}}

Much of the world's infrastructure is networked: power grids,
cellular networks, raods, and of course, the Internet.
With any critical infrastructure, the cost of failures can be
...
But despite longstanding common wisdom \cite{first_elmer-dewitt_1993},
both theoretical results and recent events (described below)
have demonstrated that
the Internet is surprisingly vulnerable to attack.
...
the ability of an attacker to succeed without trying only strengthens our
claim of the Intenrnet's vulnerability.
