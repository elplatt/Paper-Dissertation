...
\begin{figure}[t!]
\centering
\includegraphics[width=2.5in,height=2.5in]{chapters/figures/WPProdPerf/fig-eff-perf-hist.pdf}
\caption{
...
\begin{figure}[t!]
\centering
\includegraphics[width=3in,height=1.5in]{chapters/figures/WPProdPerf/fig-val-iter.pdf}
\caption{
