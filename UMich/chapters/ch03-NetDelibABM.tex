...
\begin{figure}
    ...
    \centering
    \includegraphics[width=3.33in]{chapters/figures/NetDelibABM/fig-results-netdelib-diff.eps}
...
\begin{figure}
    ...
    \centering
    \includegraphics[width=3.33in]{chapters/figures/NetDelibABM/fig-results-conform-dist.eps}
