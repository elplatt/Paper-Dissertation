...
In each run, an NK model is generated (N=15, K=6) and the model is run for 300
iterations for each network/strategy combination (see Methods for more details).
